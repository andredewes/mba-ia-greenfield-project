...
export const envValidationSchema = Joi.object({
  ...
  UPLOAD_PART_SIZE_BYTES: Joi.number().default(104857600),
  UPLOAD_PRESIGN_EXPIRY_SECONDS: Joi.number().default(21600),
  DOWNLOAD_PRESIGN_EXPIRY_SECONDS: Joi.number().default(3600),
  REDIS_HOST: Joi.string().default('redis'),
  REDIS_PORT: Joi.number().default(6379),
  VIDEO_PROCESSING_ATTEMPTS: Joi.number().default(3),
  VIDEO_PROCESSING_BACKOFF_MS: Joi.number().default(5000),
});
